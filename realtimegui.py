        ...
        if ret:
            ...
            for (x, y, w, h) in faces:
                ...
                for (ex, ey, ew, eh) in eyes:
                    ...
                    cv2.putText(frame, f"Eye State: {eye_state}", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
                    if eye_state == "Closed":
                        cv2.putText(frame, "Drowsiness Alert!", (x, y - 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
